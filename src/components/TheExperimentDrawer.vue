                    ...
                    <div class="px-4 sm:px-6 bg-green-800 py-2">
                      <div class="flex items-start justify-between">
                        <DialogTitle class="text-base font-semibold leading-6 text-white"
                          >Experimentos de Prompt</DialogTitle
                        >
                        <div class="ml-3 flex h-7 items-center">
                          <button
                            type="button"
                            class="rounded-md text-white hover:text-gray-200 focus:outline-none focus:ring-2 focus:ring-green-200 focus:ring-offset-2"
                            @click="open = false"
                          >
