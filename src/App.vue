  ...
  <div class="min-h-full">
    <div class="bg-green-600 pb-32">
      <Disclosure
        v-slot="{ open }"
        as="nav"
        class="border-b border-green-300 border-opacity-25 bg-green-600 lg:border-none"
      >
          ...
          >
            <div class="flex items-center px-2 lg:px-0">
              <div class="flex-shrink-0 flex items-center">
                ...
                <span class="font-black text-xl text-white inline-block ml-1"> LUCY </span>
              </div>
          ...
          <div class="border-t border-green-700 pb-3 pt-4">
            ...
            <div class="mt-3 space-y-1 px-2">
              <DisclosureButton
                ...
                as="a"
                :href="item.href"
                class="block rounded-md px-3 py-2 text-base font-medium text-white hover:bg-green-500 hover:bg-opacity-75"
